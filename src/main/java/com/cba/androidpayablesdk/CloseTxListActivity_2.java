...
public class CloseTxListActivity_2 extends AppCompatActivity implements PayableCallBack {

    private TextView txtStatus;
    private ListView lstClosetx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_close_tx_list_2);
        ...
        if (extras != null) {
            ...
            try {
                payable.getCloseTxs(CloseTxListActivity_2.this, Integer.parseInt(extras.getString("PageId")), Integer.parseInt(extras.getString("PageSize")),
                ...
                Result_Dialog.ResultDialog(CloseTxListActivity_2.this, e.toString());
            }
        }
    }
    ...
    private void InitViews() {
        ...
        lstClosetx = (ListView) findViewById(R.id.lstOpentx);
        lstClosetx.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    public void onSuccessCloseTx(ArrayList<PayableTX> res) {
        ...
        OpenTxAdapter openTxAdapter = new OpenTxAdapter(CloseTxListActivity_2.this, res);
        lstClosetx.setAdapter(openTxAdapter);
    }
