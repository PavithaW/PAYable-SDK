...
public class OpenTxListActivity extends AppCompatActivity implements PayableCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_tx_list);
        ...
        if(extras!=null)
        {
            ...
            try {
                payable.getOpenTxs(OpenTxListActivity.this,extras.getInt("PageNumber"), extras.getInt("PageSize"));
            } catch (PayableException e) {
                Result_Dialog.ResultDialog(OpenTxListActivity.this, e.toString());
            }
    ...
    public void onSuccessOpenTx(ArrayList<PayableTX> res) {
        ...
        OpenTxAdapter openTxAdapter = new OpenTxAdapter(OpenTxListActivity.this, res);
